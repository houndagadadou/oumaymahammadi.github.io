<?php
$con=mysqli_connect("localhost","root","","teenyweeny");
...
if (isset($_POST['submit'])){
    ...
    if (isset($_GET['id']) && $_GET['id']!=''){
        mysqli_query($con,"update categories set name='$categorie' where id='$id'");
    }
  ...
  <div class="inbox-details-default">
      ...
      <div class="inbox-details-body">
          <form class="com-mail" action="" method="post">
              ...
              <input type="submit" value="Edit Ctegory" name="submit"> 
          </form>
      </div>
  </div>
</div>
