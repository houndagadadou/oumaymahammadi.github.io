                                ...
                                <tr>
                                  ...
                                  <td><?php echo $row['name']; ?></td>
                                    ...
                                    <form action="editcat.php" method="POST">
                                      ...
                                      <button type="submit" name="edit_btn" class="btn btn-outline-secondary">Edit</button>
                                    </form>
                                  </td>
                              </tr>
                              <?php
  ...
  <div class="inbox-details-default">
      ...
      <div class="inbox-details-body">
        ...
        /*if ($conn->connect_error) {
          ...
          $categorie=$_POST['catname'];
          if (isset($_POST['submit'])){
           mysqli_query($conn,"insert into categories(name)values('$categorie')");
          
        } 
          ?>
          <form class="com-mail" action="" method="post">
              <label for="name"> Category Name</label>
              <input type="text"  value="" id="catname" name="catname">
